# app/controllers/ttdf_dashboard_controller.rb
class TtdfDashboardController < ApplicationController
  before_action :authenticate_user!
  before_action :verify_ttdf_agency
  ...
  def verify_ttdf_agency
    unless current_user.agency.code == "TTDF"
